...
mkdir ${data}/report/inductor
mv merged_details*.csv ${data}/report/inductor
mv xpu_skipped.csv ${data}/report/inductor
mv xpu_all_skipped.csv ${data}/report/inductor
...
python gen_excel.py --path ${data}/report/inductor
mv merged_data.xlsx ${data}/report/inductor/inductor_merged_data.xlsx
python gen_excel.py --path ${data}/report
mv merged_data.xlsx ${data}/report/
